...
import com.nimku.proxy.data.local.prefs.PromoPreferences
...
import com.nimku.proxy.updater.ApkDownloader
import com.nimku.proxy.updater.GitHubRelease
import com.nimku.proxy.updater.UpdateCheckResult
import com.nimku.proxy.updater.UpdateChecker
import com.nimku.proxy.work.ProxyRescanWorker
import com.nimku.proxy.work.FavoriteMonitorWorker
import com.nimku.proxy.work.UpdateCheckWorker
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ProxyRescanWorker.schedule(this, com.nimku.proxy.work.ProxyRefreshPreferences.load(this))
    ...
    private fun ScanModeSelector() {
        Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
            ...
            if (scanConfiguration.mode == ScanMode.CUSTOM) {
                TextButton(
                    onClick = {
                        startActivity(Intent(this@MainActivity, com.nimku.proxy.ui.ScanSettingsActivity::class.java))
                    }
                ) {
                    Text(
                        stringResource(
